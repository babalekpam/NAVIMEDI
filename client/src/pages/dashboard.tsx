    ...
    return (
      ...
      <div className="text-center py-8 border-2 border-dashed border-green-300 bg-green-50 rounded-lg mb-6">
        ...
        <div className="text-sm text-green-600 space-y-1">
          <p>✅ Dashboard Permission: {hasPermission('dashboard', 'view_admin') ? 'GRANTED' : 'DENIED'}</p>
          <p>✅ Users Permission: {hasPermission('users', 'view') ? 'GRANTED' : 'DENIED'}</p>
          <p>✅ Patients Permission: {hasPermission('patients', 'view') ? 'GRANTED' : 'DENIED'}</p>
        </div>
      </div>
