...
import { DollarSign, Plus, Search, Filter, FileText, Calendar, Receipt, Eye, Edit, TrendingUp, Download, Printer, RefreshCw, BarChart3, User, TestTube } from "lucide-react";
...
const labBillSchema = z.object({
  ...
  insuranceCoverageRate: z.number().min(0).max(100, "Coverage rate must be between 0 and 100").optional(),
