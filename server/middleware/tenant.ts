...
const publicRoutes = ['/api/health', '/api/platform/stats', '/api/login', '/api/auth/login', '/api/validate-token', '/api/laboratory-registration', '/api/pharmacy-registration', '/api/tenant/current', '/api/register-organization', '/api/currency/detect', '/api/currencies/african-countries'];
