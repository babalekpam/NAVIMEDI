...
- **DOCTOR APPOINTMENT RESTRICTIONS COMPLETED:** Removed all appointment scheduling capabilities from doctor dashboard - doctors can now only view appointments and receive clear messaging to contact reception for scheduling needs (Aug 13, 2025)
